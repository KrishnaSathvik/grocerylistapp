  ...
  return (
    <>
      <div style={{ display: "flex", alignItems: "center", gap: 8, height: INPUT_H, borderBottom: "2px solid var(--line)", position: "relative", zIndex: 1, marginBottom: 2 }}>
        <ContentEditable innerRef={inputRef} value={input} onChange={onInputChange} onKeyDown={onKeyDown}
          placeholder='Add item... (try "2 milk @costco")'
          style={{ flex: 1, border: "none", outline: "none", fontSize: 26, fontFamily: "'Patrick Hand', cursive", fontWeight: 500, color: "var(--ink)", background: "transparent", padding: 0, height: INPUT_H, lineHeight: `${INPUT_H}px`, letterSpacing: ".2px", caretColor: "var(--caret)", minWidth: 0, whiteSpace: "nowrap", overflow: "hidden" }} />
