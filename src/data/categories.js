export const CATEGORIES = {
  ...
  floral:     { label: "Floral",            color: "#c75b7a", emoji: "💐" },
...
export const CAT_KEYWORDS = {
  ...
  dairy: [
    ...
    "cream","heavy cream","whipping cream","half and half","half-and-half","sour cream","malai",
  ...
  frozen: [
    ...
    "smoothie blends","frozen smoothie blend","frozen fruit blend","frozen mixed fruit",
    "veggie burger","veggie burgers","plant-based burger","beyond burger","impossible burger",
  ],
  pantry: [
    ...
    "oats","oatmeal","granola","muesli","daliya","dalia","cereal","cheerios","cornflakes","corn flakes","frosted flakes",
    "pancake mix","pancake syrup","maple syrup","syrup",
    ...
    "honey","shahad","agave","molasses","corn syrup",
  ...
  snacks: [
    ...
    "protein bar","protein bars","cereal bar","cereal bars",
    "gum","chewing gum",
  ...
  condiments: [
    ...
    "curry paste","tahini","falafel","falafel mix",
  ],
  drinks: [
    ...
    "wine","red wine","white wine","rosé","rose wine","rosé wine","rose champagne","champagne","prosecco",
  ...
  household: [
    ...
    "dishwasher pods","dishwasher detergent","dishwasher tablets",
    "disinfecting wipes","lysol wipes","clorox wipes","cleaning wipes",
  ],
  health: [
  ...
  pet: [
    ...
    "poop bags","dog poop bags","waste bags","dog waste bags",
  ],
  floral: [
    "flowers","flower","bouquet","bouquets","flower bouquet","mixed bouquet",
    "tulips","tulip","roses","rose bouquet","rose flower","rose flowers","rose plant",
    "lilies","lily","orchids","orchid","carnations","carnation",
    "mums","hydrangea","sunflower","sunflowers",
    "succulent","succulents","potted plant","indoor plant","garden plant",
    "plant","plants","houseplant","houseplants",
    "floral arrangement","flower arrangement","vase flowers","fresh flowers",
  ],
};
